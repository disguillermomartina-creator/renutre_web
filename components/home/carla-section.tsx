...
<Image            src="/images/renutre/fundadora.png"            fill            alt="Carla Gerónimo, licenciada en Nutrición y fundadora de renutre®"            className="object-cover object-top"            sizes="(min-width:1024px) 44vw,100vw" />
</div>
...
```
      <div className="absolute -bottom-8 -right-5 hidden h-52 w-40 rotate-3 overflow-hidden rounded-3xl border-8 border-sand soft-shadow md:block">
        <Image
          src="/public/image/fundadora.png"
          fill
